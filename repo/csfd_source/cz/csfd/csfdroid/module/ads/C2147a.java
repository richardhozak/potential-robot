...
public interface C2147a {
    ...
    C2011b mo3445a(CsfdDataProvider c2016c, Context context);

    C2011b mo3446a(C2146b c2146b, HashMap<String, String> hashMap, C2139a c2139a, CsfdDataProvider c2016c, Context context);

    void mo3447a(CsfdDataProvider c2016c, Context context, C2057e c2057e);

    void mo3448a(boolean z);

    boolean mo3449a();

    C2011b mo3450b(C2146b c2146b, HashMap<String, String> hashMap, C2139a c2139a, CsfdDataProvider c2016c, Context context);
}
