...
public interface C2489d {
    ...
    void mo3651a(int i, C1945a<Boolean> c1945a, C2016c c2016c);
    ...
    void mo3655a(User user, Section section, C2472a c2472a, C2016c c2016c);

    void mo3656a(User user, C2477b c2477b, C2016c c2016c);

    void mo3657a(User user, C2487c c2487c, C2016c c2016c);

    Section mo3658b(Uri uri);

    void mo3659b(int i, C1945a<Boolean> c1945a, C2016c c2016c);

    void mo3660b(User user, C2477b c2477b, C2016c c2016c);
}
